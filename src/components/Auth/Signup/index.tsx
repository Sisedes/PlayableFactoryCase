...
const Signup = () => {
  ...
  const { register, isLoading, isRegisterLoading, error, clearError } = useAuthStore();
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5.5">
                  ...
                  <input
                      ...
                      autoComplete="new-password"
                      className={`rounded-lg border bg-gray-1 placeholder:text-dark-5 w-full py-3 px-5 pr-12 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20 ${
                        passwordMatchError ? 'border-red-300' : 'border-gray-3'
                      }`}
                      required
                      disabled={isLoading || isRegisterLoading}
                    />
