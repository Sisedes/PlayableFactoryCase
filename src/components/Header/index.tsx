              ...
              <div className="flex items-center gap-5">
                {isAuthenticated ? (
                  <div className="relative group">
                    ...
                    {/* Dropdown Menu */}
                    <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 absolute right-0 top-full mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg transition-all duration-200 z-50">
                      <div className="py-2">
                        <Link
                          href="/my-account"
